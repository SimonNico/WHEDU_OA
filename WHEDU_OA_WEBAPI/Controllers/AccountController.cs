...
using WHEDU_OA_WEBAPI.Providers;
using WHEDU_OA_WEBAPI.Results;
...
namespace WHEDU_OA_WEBAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Route("SetRole")]
        public async Task<IHttpActionResult>SetRole(string username,string rolename)
        {
            var oneRole = await RoleManager.FindByNameAsync(rolename);
            if(oneRole==null)
            {
